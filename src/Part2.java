...
public class Part2 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for(Integer i : beforeThis.keySet()) {
            ...
            for(Integer j : beforeThis.get(i)) {
// REPLACE THIS WITH RECURSION, OR WHATEVER.
            }
        }

        for(Integer i : afterThis.keySet()) {
            strengthValue.put(i, beforeThis.get(i).size() - afterThis.get(i).size());
        }
        ...
        while(scan.hasNext()) {
            ...
            for(String part : parts) {
                intList.add(new NewInteger(Integer.parseInt(part), strengthValue.getOrDefault(Integer.parseInt(part), 99999)));
            }
